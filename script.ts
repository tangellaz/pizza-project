...
async function main() {
  ...
  console.log(
    await createManyDynamic("pizza_components", [
      ...
      [
        { col_name: "pizza_id", value: 1 },
        { col_name: "topping_id", value: 2 },
      ],
      [
        { col_name: "pizza_id", value: 2 },
        { col_name: "topping_id", value: 2 },
      ],
      [
        { col_name: "pizza_id", value: 3 },
        { col_name: "topping_id", value: 1 },
      ],
      [
        { col_name: "pizza_id", value: 3 },
